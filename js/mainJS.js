...
//    MENU FUNCTION
    ...
    function move(){
        ...
        $('.outpage').eq(v_index).children('.in_wrap').animate({
            left: -ww * h_index,
        },1000);
...
//    EXTERIOR PAGE 3
    var chip_color = ['#eaeaea','#030505','#edebf0','#283137','141f38','#958677','#3c2325'];
    $('.color_chip').css({
    ...
    $('.wheel_wrap').click(function(){
        ...
        $('.wheel_wrap').eq(wheel_num-1).addClass('wheel_on');
        car_display();
    });
    ...
    $('.color_chip').click(function(){
        ...
        $('.color_chip').eq(chip_num-1).addClass('chip_on');
        car_display();
    });
    
    function car_display(){
        $('#car_display').attr({
            src:'img/EXT3/malibu'+chip_num+'_'+wheel_num+'_'+dir_num+'.png',
        });
    }
    
    function dir_change(){
        $('.dir_btn').removeClass('dir_on');
        $('.dir_btn').eq(dir_num-1).addClass('dir_on');
    }

//    INTERIOR PAGE 2
    $('.INT2_circle').hover(function(){
        var i = $(this).index()-3;
...
//    INTERIOR PAGE 4
    ...
    $('.INT4_bt').click(function(){
       var i = $(this).index()+1;
        ...
        $('.INT4_bt').eq(i-1).addClass('INT4_bt_on');
    });
...
//    CONVENIENCE PAGE 2
    $('.CV2_bt').click(function(){
        ...
        $('.CV2_txt_wrap').eq(i-1).addClass('CV2_on');
        $('.CV2_bt_img').removeClass('CV2_bt_on');
        $('.CV2_bt_img').eq(i-1).addClass('CV2_bt_on');
    });
...
//    CONVENIENCE PAGE 3
    ...
    $('.CV3_sel').click(function(){
        ...
        $('.CV3_sel').eq(CV3_sel_num-1).addClass('CV3_sel_on');
        CV3_bt_num =1;
        CV3_change();
    });
    ...
    function CV3_change(){        
        ...
        if(CV3_sel_num==1){
            $('.CV3_txt_wrap').eq(CV3_bt_num-1).addClass('CV3_txt_on');
            $('.CV3_bt_wrap').eq(0).addClass('CV3_bt_wrap_on');
            $('.CV3_bt_img').eq(CV3_bt_num-1).addClass('CV3_bt_on');
        }
        else if(CV3_sel_num==2){
            $('.CV3_txt_wrap').eq(CV3_bt_num-1+5).addClass('CV3_txt_on');
            $('.CV3_bt_wrap').eq(1).addClass('CV3_bt_wrap_on');
            $('.CV3_bt_img').eq(CV3_bt_num-1+5).addClass('CV3_bt_on');
        }
    }
